...
namespace Yandex.Weather.API.Models
{
    public class Day
    {
        ...
        public int TemperatureMinimum { get; set; }  // Минимальная температура для времени суток (°C).

        [JsonProperty("temp_max")]
        public int TemperatureMaximum { get; set; }  // Максимальная температура для времени суток (°C).
